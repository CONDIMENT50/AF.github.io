...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [14.231861, 6.485733, 14.332895, 6.544472], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32633',
...
map.getView().fit([14.231861, 6.485733, 14.332895, 6.544472], map.getSize());
